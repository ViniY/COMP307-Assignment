    ...
    public Population breedPopulation(EvolutionState state) {
        ...
        if (clonePipelineAndPopulation)
            ...
            if (backupPopulation == null)
                backupPopulation = state.population.emptyClone();
        ...
        for (int subpop = 0; subpop < newpop.subpops.size(); subpop++) {
            ...
            if (!shouldBreedSubpop(state, subpop, threadnum)) {
                ...
                if (clonePipelineAndPopulation)
                    ...
                    bp = newpop.subpops.get(subpop).species.pipe_prototype;
...
class SimpleBreederThread implements Runnable {
    Populatint[] numinds;
    public int[] from;
    public iimpleBreeder me;
    public SvolutionState state;
    public Ent threadnum;
    public ion newpop;
    public v
